...
int main(void) {
    ...
    if (show_only_used) {
        printf("<span foreground='#FFEECC' weight='bold'>  %.2fG  %.2fG</span>", used_gb, remaining_gb);
    } else {
        printf("<span foreground='#FFEECC' weight='bold'>  %.2fG</span>", used_gb);
    }
    printf("<span foreground='#FFEECC' size='10000'> </span>\n  ");
